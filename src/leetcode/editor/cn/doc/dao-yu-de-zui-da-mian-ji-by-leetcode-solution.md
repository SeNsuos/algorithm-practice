...
* 时间复杂度：![O(R\timesC) ](./p__O_R_times_C__.png) 。其中 *R* 是给定网格中的行数，*C* 是列数。我们访问每个网格最多一次。

* 空间复杂度：![O(R\timesC) ](./p__O_R_times_C__.png) ，递归的深度最大可能是整个网格的大小，因此最大可能使用 ![O(R\timesC) ](./p__O_R_times_C__.png)  的栈空间。
...
- 空间复杂度：![O(R\timesC) ](./p__O_R_times_C__.png) ，栈中最多会存放所有的土地，土地的数量最多为 ![R\timesC ](./p__R_times_C_.png)  块，因此使用的空间为 ![O(R\timesC) ](./p__O_R_times_C__.png) 。
...
- 空间复杂度：![O(R\timesC) ](./p__O_R_times_C__.png) ，队列中最多会存放所有的土地，土地的数量最多为 ![R\timesC ](./p__R_times_C_.png)  块，因此使用的空间为 ![O(R\timesC) ](./p__O_R_times_C__.png) 。